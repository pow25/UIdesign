$(document).ready(function() {
    ...
    if(shape_process > letter_process){
        $("#right").append("<img src='/static/other/left.gif' class='arrow' style='transform:rotate(180deg);' >");
    }
    else{
        $("#left").append("<img src='/static/other/left.gif' class='arrow'>");
    }
